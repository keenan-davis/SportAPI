...
namespace SportsTriviaAPI.Data
{
    public class QuestionsSeed
    {
        public static List<Question> Questions = new List<Question>
        {
            ...
            new Question { Id = 1004, Category = "Football", Difficulty = "easy", Text = "Which player is known as 'CR7'?", Options = new() { "Cristiano Ronaldo", "Lionel Messi", "Neymar", "Mbappé" }, CorrectAnswer = "Cristiano Ronaldo" },
            ...
            new Question { Id = 1015, Category = "Football", Difficulty = "medium", Text = "Who is the Premier League’s all-time top scorer?", Options = new() { "Wayne Rooney", "Serggio Agüero", "Alan Shearer", "Harry Kane" }, CorrectAnswer = "Alan Shearer" },
...
new Question {
    ...
    CorrectAnswer = "Ace",
    Options = new() { "Ace", "Love", "Break", "Deuce" }
},
...
new Question {
    ...
    CorrectAnswer = "None (Tiger Woods won Career Grand Slam)",
